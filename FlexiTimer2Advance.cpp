/*
  FlexiTimer2Advance.h - Using timer2 with a configurable resolution
...
unsigned long FlexiTimer2Advance::time_units;
void (*FlexiTimer2Advance::func)();
volatile unsigned long FlexiTimer2Advance::count;
volatile char FlexiTimer2Advance::overflowing;
volatile unsigned int FlexiTimer2Advance::tcnt2;
#if defined(__arm__) && defined(TEENSYDUINO)
static IntervalTimer itimer;
#endif

void FlexiTimer2Advance::set(unsigned long ms, void (*f)()) {
    FlexiTimer2Advance::set(ms, 0.001, f);
}
 ...
 */
void FlexiTimer2Advance::set(unsigned long units, int resolution, void (*f)()) {
  float prescaler = 0.0;
...
void FlexiTimer2Advance::start() {
  ...
  TIMSK4 = (1<<TOIE4);
#elif defined(__arm__) && defined(TEENSYDUINO)
  itimer.begin(FlexiTimer2Advance::_overflow, tcnt2);
#endif
}

void FlexiTimer2Advance::stop() {
#if defined (__AVR_ATmega168__) || defined (__AVR_ATmega48__) || defined (__AVR_ATmega88__) || defined (__AVR_ATmega328P__) || defined (__AVR_ATmega1280__) || defined(__AVR_ATmega2560__) || defined(__AVR_AT90USB646__) || defined(__AVR_AT90USB1286__)
  TIMSK2 &= ~(1<<TOIE2);
#elif defined (__AVR_ATmega128__)
  TIMSK &= ~(1<<TOIE2);
...
void FlexiTimer2Advance::_overflow() {
  count += 1;
...
#endif
#if defined (__AVR_ATmega168__) || defined (__AVR_ATmega48__) || defined (__AVR_ATmega88__) || defined (__AVR_ATmega328P__) || defined (__AVR_ATmega1280__) || defined(__AVR_ATmega2560__) || defined(__AVR_AT90USB646__) || defined(__AVR_AT90USB1286__)
  TCNT2 = FlexiTimer2Advance::tcnt2;
#elif defined (__AVR_ATmega128__)
  TCNT2 = FlexiTimer2Advance::tcnt2;
#elif defined (__AVR_ATmega8__)
  TCNT2 = FlexiTimer2Advance::tcnt2;
